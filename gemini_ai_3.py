...
questions = [
    "Provide a title of virat kholi with heading as 'Title:' and Introduction of 7 lines with heading as 'Introduction:' and pics with heading as 'Images:' ",
...
print("json has been saved to 'famous_personality_virat_kholi1.json'")
