...
questions = [
    "Provide a title of Mukesh Ambani with heading as 'Title:' and Introduction of 7 lines with heading as 'Introduction:' ",
    "Provide following details of Mukesh Ambani - Birth date with heading as 'Birth date:' and place of birth with heading as 'place of birth', Fathers name with heading 'Father's name:',mothers name with heading 'Mothers name:',brother name with heading as 'brothers name:' , sisters name heading as 'sisters name:', early education with heading as 'Early education:', Family values with heading as 'family values:', education values  with heading only as 'Education values:', Marriage details as 'Marriage details:'",
    "Provide following details of Mukesh Ambani - a chronological timeline for key events, showcasing career journey with heading 'Carrer Journey:', professional struggle with heading 'Professional struggle:', business ventures with heading 'Business ventures:', and contributions to the country economy  with heading as 'Contributions to the Country Economy:' ",
    "Provide following details of Mukesh Ambani - prestigious awards and recognitions with heading 'Awards and recognitions:' ",
    "Provide following details of Mukesh Ambani- anecdotes with heading 'Anecdots:' and controversies with heading 'Controversies:' in 6-7 short points .",
    "Provide key personality attributes of Mukesh Ambani with heading 'Personality Attributes:' 10 points ",
    "Provide contribution of Mukesh Ambani to society with heading 'society:' and philanthropy with heading 'philanthropy:' 8 points each",
    "Provide the following details about Mukesh Ambani - famous quotes with heading 'Famous quotes:', what do colleagues say with same heading as 'Thoughts:' 7 points each",
    "What is the current status of Mukesh Ambani - with heading 'Current Status:' with 8 points  ",
...
with open('Json_files/famous_personality_Muskesh_Ambani.json', 'w') as json_file:
    json_file.write(json_output)

print("json has been saved to 'famous_personality_Mukesh_Ambani.json'")
